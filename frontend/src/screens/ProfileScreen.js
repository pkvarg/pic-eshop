...
const ProfileScreen = () => {
  ...
  return (
    <Row className='mt-10 mx-2'>
      <Col md={3}>
        <h2 className='mb-4'>Môj profil</h2>
        ...
        <Form onSubmit={submitHandler}>
          ...
          <h1 className='my-4'>Zmena hesla</h1>
          ...
          <Button type='submit' className='my-5 bg-violet rounded'>
            Upraviť profil
          </Button>
        </Form>
      </Col>
      <Col md={9}>
        <h2 className='mb-4'>Moje objednávky</h2>
        {loadingOrders ? (
          <Loader />
        ) : errorOrders ? (
